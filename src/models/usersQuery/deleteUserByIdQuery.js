...
const updateUserEmailToDeletedQuery = async (userId) => {
    ...
    try {
        ...
        await connection.query('UPDATE users SET modifiedAt = ?, email = ?, password = ?, username = ?, role = NULL, avatar = NULL, personalInfo = NULL WHERE id = ?',
            [new Date(), deleteUserS, deleteUserS, deleteUserS, userId]);
    } finally {
