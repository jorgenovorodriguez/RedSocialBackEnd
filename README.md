...
- Se trata de una web donde los usuarios tienen dos roles (artista o estudio), los primeros publican fotos de sus trabajos y los segundos publican "ofertas de empleo".
...
- Sólo los usuarios registrados pueden acceder a los datos de contacto de lols demas usuarios y ver el total de sus publicaciones.
